...
export const VALIDATION_SERVER_URL =
  'https://unique-back.prototypo.io/create-package/';
...
// }`;
const AWS_URL = `https://${
  process.env.UNIQUE_ENV === 'production' ? 'tc1b6vq6o8' : 'tc1b6vq6o8'
}.execute-api.eu-west-1.amazonaws.com/${
  process.env.UNIQUE_ENV === 'production' ? 'dev' : 'dev'
}`;
...
export const FACEBOOK_APP_ID =
  process.env.UNIQUE_ENV === 'production' ? '569126220107317' : '569126220107317';
