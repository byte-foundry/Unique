...
export const storeCreatedFont = (createdFont, fontName) => (
	dispatch,
	getState,
) => {
...
function initFontFactory(prototypoFontFactory, resolve, dispatch) {
	prototypoFontFactory
		.init(undefined, undefined, TEMPLATE_URL)
		.then(() => {
			dispatch({
...
export const createPrototypoFactory = () => (dispatch, getState) => {
	...
	const createdPrototypoFontFactory = new Ptypo(
		'b1f4fb23-7784-456e-840b-f37f5a647b1c',
	);
